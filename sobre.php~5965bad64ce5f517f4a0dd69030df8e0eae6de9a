<!DOCTYPE	html>
	<html>
		<head>
			...
			<!--	<link rel = "stylesheet" href="estilos.css"> <!-- link = para linkar e chamar todas as caracteristicas do css -->
			...
			<style> 
				 p {
					...
					background-color: red; <!-- altera a cor do fundo do texto -->
				 <!--  } </style> -->
	    </head>
		<body>
...
distribuem nossos produtos às casas do mundo todo. Nosso centro de distribuição:
		...
		<figure id="centro-distribuicao"> <!-- para centralizar a margem da foto-->
...
se tiver dúvidas. Conheça também nossa <a href="#historia">histórias </a> e nossos <a href="#diferenciais"> diferenciais.</a> <!--Inserindo a ancora com seus respectivos ids -->
</p>


<h2 id="historias">História</h2> <!--para criar âncoras-->
